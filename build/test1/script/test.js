...
(function (illa) {
    var Arrkup = (function () {
        ...
        Arrkup.prototype.getSource = function () { return this.source; };
        Arrkup.prototype.setSource = function (value) { this.source = value; };
        Arrkup.prototype.getAllowRaw = function () { return this.allowRaw; };
        Arrkup.prototype.setAllowRaw = function (flag) { this.allowRaw = flag; };
...
(function (illa) {
    var FunctionUtil = (function () {
        ...
        FunctionUtil.throttle = function (thisArg, fn, delay) {
            var timeoutRef;
    ...
    illa.FunctionUtil = FunctionUtil;
})(illa || (illa = {}));
/// <reference path='_module.ts'/>
var illa;
(function (illa) {
...
(function (illa) {
    var Map = (function () {
        ...
        Map.prototype.getLength = function () { return this.keys.length; };
...
(function (illa) {
    var Rectangle = (function () {
        ...
        Rectangle.prototype.getOffset = function (axis, alignment) {
            if (alignment === void 0) { alignment = illa.Alignment.START; }
            var offset = NaN;
            switch (axis) {
                case illa.Axis2D.X:
                    offset = this.x;
        ...
        Rectangle.prototype.equals = function (value) {
            return !!value &&
                value.getOffset(illa.Axis2D.X) == this.getOffset(illa.Axis2D.X) &&
                value.getOffset(illa.Axis2D.Y) == this.getOffset(illa.Axis2D.Y) &&
                value.getSize(illa.Axis2D.X) == this.getSize(illa.Axis2D.X) &&
                value.getSize(illa.Axis2D.Y) == this.getSize(illa.Axis2D.Y);
        };
        Rectangle.prototype.toString = function () {
            return '[illa.Rectangle x=' + this.getOffset(illa.Axis2D.X) + ' y=' + this.getOffset(illa.Axis2D.Y) +
                ' width=' + this.getSize(illa.Axis2D.X) + ' height=' + this.getSize(illa.Axis2D.Y) + ']';
        };
        Rectangle.prototype.expand = function (top, right, bottom, left) {
            return new Rectangle(this.getOffset(illa.Axis2D.X) - left, this.getOffset(illa.Axis2D.Y) - top, this.getSize(illa.Axis2D.X) + left + right, this.getSize(illa.Axis2D.Y) + top + bottom);
        };
        Rectangle.prototype.containsRect = function (rect) {
            ...
            if (rect) {
                ...
                for (var axis = illa.Axis2D.X; axis <= illa.Axis2D.Y; axis++) {
                    if (rect.getOffset(axis, illa.Alignment.START) < this.getOffset(axis, illa.Alignment.START) ||
                        rect.getOffset(axis, illa.Alignment.END) > this.getOffset(axis, illa.Alignment.END)) {
                        result = false;
                        break;
                    }
                }
...
(function (test1) {
    var Main = (function () {
        function Main() {
            ...
            var throttleTest = function (a, b, c) {
        ...
        Main.prototype.onThrottleFinished = function () {
